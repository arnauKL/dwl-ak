...
#include "dwl-colors.h"     // Include colors generated by wallust
...
#endif
    // [SchemeSel] = {0xffffffff, WALLUST_BG, WALLUST_COL3},    // integration
    // from colors.h
...
static const char *menucmd[]
    = { "wmenu-run", "-b", "-i",       "-f", "monospace bold 9", "-N",
...
static const char *toggle_bgcmd[]
    = { "sh", "/home/ak/scripts/toggle-swaybg.sh", NULL };
static const char *random_bgcmd[]
    = { "sh", "/home/ak/scripts/random-wal.sh", NULL };
...
static const Key keys[] = {
    ...
    {WLR_MODIFIER_LOGO,                         XKB_KEY_2,      spawn,      {.v = random_bgcmd}},
...
#define CHVT(n)                                                                                                        \
    ...
    CHVT(12),
    /* Media keys */
    {0, XF86XK_AudioRaiseVolume, spawn, {.v = (const char *[]){"sh", "/home/ak/scripts/change-vol.sh", "up", NULL}}},
    {0, XF86XK_AudioLowerVolume, spawn, {.v = (const char *[]){"sh", "/home/ak/scripts/change-vol.sh", "down", NULL}}},
    {0, XF86XK_AudioMute, spawn, {.v = (const char *[]){"sh", "/home/ak/scripts/change-vol.sh", "mute", NULL}}},
    {0, XF86XK_MonBrightnessUp, spawn, {.v = (const char *[]){"sh", "/home/ak/scripts/change-brightness.sh", "up", NULL}}},
    {0, XF86XK_MonBrightnessDown, spawn, {.v = (const char *[]){"sh", "/home/ak/scripts/change-brightness.sh", "down", NULL}}},
};
